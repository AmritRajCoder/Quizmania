...
export default function Landing({ navigation }) {
    ...
    useEffect(() => {
        (async () => {
            ...
            // this.animation.reset();//reset and play animation. this is the syntax
            // this.animation.play();
        })();
        ...
        });// DOUBT DOUBT - Why inside? - To check all the time if it is clicked. useEffect is global
    }, []);
                ...
                isLoading ?
                    ...
                    <>
                        <View style={styles.animationContainer}>
                            ...
                            /> */}
                            {/*require is for loading animation*/}
                        </View>
